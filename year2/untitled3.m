...
lme_swe = fitlme(int_data, 'twre_swe_ss ~ 1 + int_session_cat + (1|record_id) + (int_session_cat - 1|record_id)');
lme_pde = fitlme(int_data, 'twre_pde_ss ~ 1 + int_session_cat + (1|record_id) + (int_session_cat - 1|record_id)');
% Create figure
figure; hold;
dmap = lines; 
% Organize data
