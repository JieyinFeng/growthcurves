...
corr_table = table(brs_change, rf_change,twre_change, ...
    lwid_change, wa_change, swe_change, pde_change, ...
    or_change, srf_change, rti_brs, rti_rf, rti_twre, ...
    rti_lwid, rti_wa, rti_swe, rti_pde, rti_or, rti_srf);
corr_table.Properties.VariableNames = {'brs_change', 'rf_change','twre_change', ...
    'lwid_change', 'wa_change', 'swe_change', 'pde_change', ...
    'or_change', 'srf_change', 'rti_brs', 'rti_rf', 'rti_twre', ...
    'rti_lwid', 'rti_wa', 'rti_swe', 'rti_pde', 'rti_or', 'rti_srf'};
[corr_r,corr_p] = corrplot(corr_table, 'type','Pearson','testR','on');
